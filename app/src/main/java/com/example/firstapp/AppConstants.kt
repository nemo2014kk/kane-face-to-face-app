...
object AppConstants {
    ...
    val LANG_GROUPS = mapOf(
        ...
        "欧美" to listOf("英语", "法语", "德语", "西班牙语", "斯洛伐克语", "葡萄牙语", "意大利语", "俄语", "乌克兰语", "亚美尼亚语", "格鲁吉亚语", "克罗地亚语", "匈牙利语", "波兰语", "荷兰语", "瑞典语", "立陶宛语"),
