...
object AppConstants {
    ...
    val DEFAULT_VOICE_MAP = mapOf(
        ...
        // 👇 拆分为拉丁和西里尔，但共享相同的默认发音人
        "塞尔维亚语 (拉丁)" to "Sophie (塞尔维亚语·柔美女声)",
        "塞尔维亚语 (西里尔)" to "Sophie (塞尔维亚语·柔美女声)"
    )

    val LANG_GROUPS = mapOf(
        "亚洲" to listOf("中文", "粤语", "日语", "韩语", "泰语", "越南语", "蒙古语", "印尼语", "印地语", "孟加拉语", "菲律宾语"),
        // 👇 在欧美列表的最后面，加上了 "塞尔维亚语"
        "欧美" to listOf("英语", "法语", "德语", "西班牙语", "斯洛伐克语", "葡萄牙语", "意大利语", "俄语", "乌克兰语", "亚美尼亚语", "格鲁吉亚语", "克罗地亚语", "匈牙利语", "波兰语", "荷兰语", "瑞典语", "立陶宛语", "塞尔维亚语 (拉丁)", "塞尔维亚语 (西里尔)"),
    ...
    val LANG_MAP_EN = mapOf(
        ...
        // 👇 大模型翻译目标语言指令分离
        "塞尔维亚语 (拉丁)" to "Serbian (Latin script)",
        "塞尔维亚语 (西里尔)" to "Serbian (Cyrillic script)"
    )
    ...
    val LANG_CODES = mapOf(
        ...
        // 👇 Whisper 识别代号分离 (内部伪代码)
        "塞尔维亚语 (拉丁)" to "sr-latn",
        "塞尔维亚语 (西里尔)" to "sr-cyrl"
    )
